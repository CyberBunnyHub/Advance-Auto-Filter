...
BOT_TOKEN = environ.get('BOT_TOKEN', "7845318227:AAGfr0cikK92HY-DhIGMVTD3L0VeaKktUp8")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002405551053').split()]
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002405551053'))
